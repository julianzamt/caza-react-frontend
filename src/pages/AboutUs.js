  ...
  return (
    <div>
      ...
      <div className="aboutUs__container">
        ...
        <p className="border-top p-3 aboutUs__cv text-justify">
          <b>María Zamtlejfer</b> es arquitecta por la Facultad de Arquitectura, Diseño y Urbanismo de la Universidad de Buenos Aires. En el año 2010
          pasa a formar parte del estudio Galli centrado en proyectos de interiorismo. Entre el 2012 y el 2015 continúa su carrera profesional en el
          Estudio GSA (Gonzalo Suárez Aboy y asociados) desarrollando el proyecto y documentación de conjuntos habitacionales de escala media mientras
          que, paralelamente, inicia su actividad profesional independiente llevando a cabo comisiones particulares. Fue docente ayudante en la
          materia Morfología I y II (Taller Forma y Proyecto) - FADU UBA -
        </p>
      </div>
    </div>
  );
